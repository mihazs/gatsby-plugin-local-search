...
const createLunrIndexExport = ({
  ...
  if (languages !== undefined) enhanceLunr(lunr, languages);
  const index = lunr(function () {
    if (languages !== undefined) languages.forEach(name => {
      if (name !== "en") this.use(lunr[name]);
    });
    this.ref(ref);
...
const createIndexExport = (_ref) => {
  let {
    ...
    engine
      ...
      args = (0, _objectWithoutProperties2.default)(_ref, ["reporter", "name", "engine"]);
...
exports.onCreateWebpackConfig = ({
  ...
  if (languages !== undefined) actions.setWebpackConfig({
    plugins: [plugins.ignore({
